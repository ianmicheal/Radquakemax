...
/* speud - VMU and rumble pack begin */
#include <kos.h>
#include <dc/pvr.h>
...
cvar_t	max_fps = {"max_fps", "72"};		// 2001-12-16 MAX_FPS cvar by MrG
...
void Host_InitLocal (void)
{
	...
	Cvar_RegisterVariable (&max_fps); // 2001-12-16 MAX_FPS cvar by MrG
...
//	if (!cls.timedemo && realtime - oldrealtime < 1.0/72.0)
	if (max_fps.value < 10)	Cvar_SetValue ("max_fps", 72);
...
/* speud - load default config begin */
...
"viewsize \"100\"\n"
"vid_disp_mode \"6\"\n"
"vid_screen_height \"480\"\n"
"vid_screen_width \"640\"\n"
"vid_screen_y \"0\"\n"
"vid_screen_x \"0\"\n"
"dc_strafe_threshold \"0.15\"\n"
"dc_walk_threshold \"0.15\"\n"
"dc_yaw_threshold \"0.15\"\n"
"dc_pitch_threshold \"0.15\"\n"
"dc_axisy2_scale \"1\"\n"
"dc_axisx2_scale \"1\"\n"
"dc_axisr_scale \"1\"\n"
"dc_axisl_scale \"1\"\n"
"dc_axisy_scale \"1\"\n"
"dc_axisx_scale \"1\"\n"
"dc_axisy2_function \"2\"\n"
"dc_axisx2_function \"3\"\n"
"dc_axisr_function \"0\"\n"
"dc_axisl_function \"0\"\n"
"dc_axisy_function \"4\"\n"
"dc_axisx_function \"1\"\n"
...
/* speud - rumble pack begin */
	purupuru_init();
	maple_hw_init();
/* speud - rumble pack end */
...
/*
	// BlackAura (11-12-2002) - Set up Dreamcast controls
	#ifdef _arch_dreamcast
		Cbuf_InsertText (";bind \"DC_START\" \"togglemenu\"\n" // Manoel Kasimier - edited
			"bind \"DC_A\" \"+back\"\n"
			"bind \"DC_B\" \"+moveright\"\n"
			"bind \"DC_X\" \"+moveleft\"\n"
			"bind \"DC_Y\" \"+forward\"\n"
...
/* speud - load options begin */
	Host_ReadConfiguration();
/* speud - load options end */
...
// keep Con_Printf from trying to update the screen
	...
	if (cls.state != ca_dedicated)
	{
     ...
     void *subelf; 
      int length;	
       iso_ioctl(0,NULL,0);
         length = fs_load("/cd/rad.mod", &subelf); // Reload mod menu from Quake menu with quit  Ian micheal 2019
